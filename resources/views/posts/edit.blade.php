                    ...
                    <div class="row">
                        <form method="POST" action="{{ url('/editPost',array($posts->id)) }}" aria-label="{{ __('Register') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="post_title" type="post_title" class="form-control{{ $errors->has('post_title') ? ' is-invalid' : '' }}" name="post_title" value="{{ $posts->post_title }}" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="category_id" type="category_id" class="form-control{{ $errors->has('category_id') ? ' is-invalid' : '' }}" name="category_id">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="post_image" type="file" value="{{$posts->post_image}}" class="form-control{{ $errors->has('post_image') ? ' is-invalid' : '' }}" name="post_image">
